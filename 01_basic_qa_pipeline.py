...
Original file is located at
    https://colab.research.google.com/github/deepset-ai/haystack-tutorials/blob/main/tutorials/01_Basic_QA_Pipeline.ipynb
...
# Changed to use a local copy (must be executed from directly that this file is in)

# reader = FARMReader(
#     model_name_or_path="./roberta-base-squad2", use_gpu=True)
